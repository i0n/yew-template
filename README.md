...
template for use with https://github.com/cargo-generate/cargo-generate
...
There are two empty spaces in the MIT license you need to fill out: `` and `Ian Alexander Wood <ianalexanderwood@gmail.com>`.
